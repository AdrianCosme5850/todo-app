    ...
    function MultiSelect2() {
        ...
        _this.getPopoverTargetRenderer = function (listProps, isOpen) {
            ...
            return function (_a) {
                ...
                return React.createElement(targetTagName, __assign(__assign(__assign({ "aria-autocomplete": "list", "aria-controls": _this.listboxId }, popoverTargetProps), targetProps), { "aria-expanded": isOpen, 
