    ...
    function Select2() {
        ...
        _this.getPopoverTargetRenderer = function (listProps, isOpen) {
            ...
            return function (_a) {
                ...
                var _c = _this.props, _d = _c.popoverProps, popoverProps = _d === void 0 ? {} : _d, popoverTargetProps = _c.popoverTargetProps;
                var handleKeyDown = listProps.handleKeyDown, handleKeyUp = listProps.handleKeyUp;
                var _e = popoverProps.targetTagName, targetTagName = _e === void 0 ? "div" : _e;
                return React.createElement(targetTagName, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ "aria-controls": _this.listboxId }, popoverTargetProps), targetProps), { "aria-expanded": isOpen, 
